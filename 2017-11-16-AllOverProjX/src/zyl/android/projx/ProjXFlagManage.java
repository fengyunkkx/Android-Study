...
public class ProjXFlagManage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.projxflagmanage);// 设置布局文件
		...
		strid = bundle.getString(ProjXShowinfo.FLAG);// 将便签id转换为字符串
		final FlagDAO flagDAO = new FlagDAO(ProjXFlagManage.this);// 创建FlagDAO对象
		...
		btnEdit.setOnClickListener(new OnClickListener() {// 为修改按钮设置监听事件
			...
			public void onClick(View arg0) {
				...
				// 弹出信息提示
				Toast.makeText(ProjXFlagManage.this, "〖便签数据〗修改成功！",
		...
		btnDel.setOnClickListener(new OnClickListener() {// 为删除按钮设置监听事件
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(ProjXFlagManage.this, "〖便签数据〗删除成功！",
						Toast.LENGTH_SHORT).show();
			}
		});
	}
