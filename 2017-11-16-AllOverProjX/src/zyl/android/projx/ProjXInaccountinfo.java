...
public class ProjXInaccountinfo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.projxinaccountinfo);// 设置布局文件
		...
		lvinfo.setOnItemClickListener(new OnItemClickListener()// 为ListView添加项单击事件
		{
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(ProjXInaccountinfo.this, ProjXInfoManage.class);// 创建Intent对象
	...
	private void ShowInfo(int intType) {// 用来根据传入的管理类型，显示相应的信息
		...
		InaccountDAO inaccountinfo = new InaccountDAO(ProjXInaccountinfo.this);// 创建InaccountDAO对象
