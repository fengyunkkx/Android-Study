...
public class ProjXInfoManage extends Activity {
	...
	OutaccountDAO outaccountDAO = new OutaccountDAO(ProjXInfoManage.this);// 创建OutaccountDAO对象
	InaccountDAO inaccountDAO = new InaccountDAO(ProjXInfoManage.this);// 创建InaccountDAO对象

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.projxinfomanage);// 设置布局文件
		...
		strInfos = bundle.getStringArray(ProjXShowinfo.FLAG);// 获取Bundle中记录的信息
		...
		btnEdit.setOnClickListener(new OnClickListener() {// 为修改按钮设置监听事件
			...
			public void onClick(View arg0) {
				...
				// 弹出信息提示
				Toast.makeText(ProjXInfoManage.this, "〖数据〗修改成功！", Toast.LENGTH_SHORT)
						.show();
			}
		});
		...
		btnDel.setOnClickListener(new OnClickListener() {// 为删除按钮设置监听事件
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(ProjXInfoManage.this, "〖数据〗删除成功！", Toast.LENGTH_SHORT)
						.show();
			}
		});
