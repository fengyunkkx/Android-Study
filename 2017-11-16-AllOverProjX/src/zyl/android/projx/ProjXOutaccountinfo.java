...
public class ProjXOutaccountinfo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.projxoutaccountinfo);// 设置布局文件
		...
		lvinfo.setOnItemClickListener(new OnItemClickListener()// 为ListView添加项单击事件
		{
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(ProjXOutaccountinfo.this,
						ProjXInfoManage.class);// 创建Intent对象
	...
	private void ShowInfo(int intType) {// 用来根据传入的管理类型，显示相应的信息
		...
		OutaccountDAO outaccountinfo = new OutaccountDAO(ProjXOutaccountinfo.this);// 创建OutaccountDAO对象
